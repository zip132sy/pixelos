...
window.newInput = function(text, placeholder, textMask)
	return GUI.input(1, 1, 1, 1, 0x1E1E1E, 0xC3C3C3, 0x5A5A5A, 0x1E1E1E, 0xD2D2D2, text, placeholder, false, textMask)
end
...
local function new()
	...
	local function addInput(text, placeholder, textMask)
		return layout:addChild(GUI.input(1, 1, 36, 3, 0xE1E1E1, 0x696969, 0x969696, 0xE1E1E1, 0x2D2D2D, text, placeholder, false, textMask))
	end

	local widthInput = addInput("", locale.width, nil)
	layout:addChild(GUI.text(1, 1, 0x696969, " x "))
	local heightInput = addInput("", locale.height, nil)
