...
module.onTouch = function()
	...
	-- Add 24-hour format switch
	window.contentLayout:addChild(GUI.text(1, 1, 0x2D2D2D, localization.time24HourFormat))
	
	local format24Switch = window.contentLayout:addChild(GUI.switchAndLabel(1, 1, 36, 8, 0x66DB80, 0xE1E1E1, 0xFFFFFF, 0xA5A5A5, localization.timeUse24HourFormat .. ":", userSettings.time24HourFormat or true)).switch
	...
	comboBox.onItemSelected = function()
		...
		userSettings.time24HourFormat = format24Switch.state
	...
	input.onInputFinished, switch.onStateChanged, format24Switch.onStateChanged = comboBox.onItemSelected, comboBox.onItemSelected, comboBox.onItemSelected
end
