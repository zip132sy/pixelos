...
module.onTouch = function()
	...
	local function addInput(parent, text, placeholder, textMask)
		return parent:addChild(GUI.input(1, 1, 36, 3, 0xE1E1E1, 0x696969, 0xA5A5A5, 0xE1E1E1, 0x2D2D2D, text, placeholder, false, textMask))
	end
	...
	local renameInput = addInput(window.contentLayout, "", localization.usersChangeNamePlaceholder, nil)
	
	local passwordButton = addButton(window.contentLayout, 1, 36, "")
	local passwordInput = addInput(window.contentLayout, "", localization.usersAddPasswordPlaceholder1, nil, "•")
	local submitPasswordInput = addInput(window.contentLayout, "", localization.usersAddPasswordPlaceholder2, nil, "•")
