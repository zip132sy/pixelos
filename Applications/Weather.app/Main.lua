...
local defaultCity = "Санкт-Петербург"
if userSettings.localizationLanguage == "ChineseSimplified" or userSettings.localizationLanguage == "ChineseTraditional" then
	defaultCity = "Beijing"
end
