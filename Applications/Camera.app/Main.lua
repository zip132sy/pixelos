...
-- Set custom icon path for this application
if not userSettings.iconCustomPaths then
	userSettings.iconCustomPaths = {}
end
if not userSettings.iconCustomPaths[system.getCurrentScript()] then
	userSettings.iconCustomPaths[system.getCurrentScript()] = ""
end
system.icon.customIconPath = userSettings.iconCustomPaths[system.getCurrentScript()] or ""
