...
local function addInput(text, placeholder, multiline)
	return toolLayout:addChild(GUI.input(1, 1, toolLayout.width - 2, multiline and 3 or 1, 0x1E1E1E, 0xA5A5A5, 0x5A5A5A, 0x1E1E1E, 0xE1E1E1, text, placeholder, false, nil))
end
