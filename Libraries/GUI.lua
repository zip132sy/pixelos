...
local function workspaceStart(workspace, eventPullTimeout)
	...
	repeat
		e1, e2, e3, e4, e5, e6, e7, e8, e9, e10, e11, e12, e13, e14, e15, e16, e17, e18, e19, e20, e21, e22, e23, e24, e25, e26, e27, e28, e29, e30, e31, e32 = event.pull(workspace.animations and 0.1 or workspace.eventPullTimeout)
		
		-- 处理按钮点击事件
		if e1 == "button_press" then
			local buttonWorkspace, button, buttonE1, e5, e6, e7, e8, e9, e10, e11, e12, e13, e14, e15, e16, e17, e18, e19, e20, e21, e22, e23, e24, e25, e26, e27, e28, e29, e30, e31, e32 = e2, e3, e4, e5, e6, e7, e8, e9, e10, e11, e12, e13, e14, e15, e16, e17, e18, e19, e20, e21, e22, e23, e24, e25, e26, e27, e28, e29, e30, e31, e32
			if button and button.onTouch then
				button.onTouch(buttonWorkspace, button, buttonE1, e5, e6, e7, e8, e9, e10, e11, e12, e13, e14, e15, e16, e17, e18, e19, e20, e21, e22, e23, e24, e25, e26, e27, e28, e29, e30, e31, e32)
			end
			-- 恢复按钮状态
			if button then
		...
		if workspace.animations then
			...
			-- 减少动画处理频率
			if currentTime - lastAnimationTime >= 0.05 then
				...
				while animationIndex <= #workspace.animations do
					...
					if animation.removeLater then
						...
						if animation.started then
							animation.position = (currentTime - animation.startUptime) / animation.duration
...
local function buttonPress(button, workspace, object, ...)
	if button.onTouch then
		button.onTouch(workspace, button, ...)
	end
end
...
local function buttonEventHandler(workspace, button, e1, ...)
	if e1 == "touch" and (not button.animated or not button.animationStarted) then
		...
		-- 延迟执行onTouch，让视觉反馈先显示
		computer.pushSignal("button_press", workspace, button, e1, ...)
	end
end
