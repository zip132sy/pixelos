...
local files={"OS.lua","Libraries/GUI.lua","Libraries/Filesystem.lua","Libraries/Event.lua","Libraries/Screen.lua","Libraries/System.lua","Libraries/Paths.lua","Libraries/Color.lua","Libraries/Text.lua","Libraries/Number.lua","Libraries/Image.lua","Libraries/Keyboard.lua","Libraries/Bit32.lua","Libraries/Network.lua","Libraries/Component.lua","Libraries/GPU.lua","Libraries/SHA-256.lua"}
